...
namespace IMCore.Data.Migrations
{
    ...
    [Migration("20190409185146_Material")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMCore.Domain.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("IMCore.Domain.MaterialCategoryBasicLaborMappings", b =>
                {
                    ...
                    b.HasKey("MaterialId", "BasicLaborId");

                    b.HasIndex("BasicLaborId");

                    b.ToTable("MaterialBasicLaborMapping");
                });
            ...
            modelBuilder.Entity("IMCore.Domain.MaterialCategoryItemMappings", b =>
                {
                    ...
                    b.HasKey("MaterialId", "ItemId");

                    b.HasIndex("ItemId");

                    b.ToTable("MaterialsItemMapping");
                });
            ...
            modelBuilder.Entity("IMCore.Domain.MaterialCategoryOptionsMappings", b =>
                {
                    ...
                    b.HasKey("MaterialId", "OptionId");

                    b.HasIndex("OptionId");

                    b.ToTable("MaterialsOptionsMapping");
                });
            ...
            modelBuilder.Entity("IMCore.Domain.ProgramBranchMapping", b =>
                {
                    ...
                    b.HasKey("ProgramId", "BranchId");

                    b.HasIndex("BranchId");

                    b.ToTable("ProgramBranchMapping");
                });
            ...
            modelBuilder.Entity("IMCore.Domain.UserBranchDivisionAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("UserBranchDivisionAssignments");
                });
            ...
            modelBuilder.Entity("IMCore.Domain.BasicCost", b =>
                {
                    ...
                    b.HasOne("IMCore.Domain.Branch", "Branch")
                        .WithMany("Costs")
            ...
            modelBuilder.Entity("IMCore.Domain.MaterialCategoryBasicLaborMappings", b =>
                {
                    b.HasOne("IMCore.Domain.BasicLabor", "BasicLabor")
                        .WithMany("MaterialBasicLaborMappings")
                        .HasForeignKey("BasicLaborId")
                        .HasConstraintName("FK_MaterialBasicLaborMapping_BasicLabor");

                    b.HasOne("IMCore.Domain.Material", "Material")
                        .WithMany("MaterialBasicLaborMappings")
            ...
            modelBuilder.Entity("IMCore.Domain.MaterialCategoryItemMappings", b =>
                {
                    b.HasOne("IMCore.Domain.Item", "Item")
                        .WithMany("MaterialItemMappings")
                        .HasForeignKey("ItemId")
                        .HasConstraintName("FK_MaterilCategoryItemMappings_Item");

                    b.HasOne("IMCore.Domain.Material", "Material")
                        .WithMany("MaterialsItemMappings")
                        .HasForeignKey("MaterialId")
            ...
            modelBuilder.Entity("IMCore.Domain.MaterialCategoryOptionsMappings", b =>
                {
                    b.HasOne("IMCore.Domain.Material", "Material")
                        .WithMany("MaterialOptionsMappings")
                        .HasForeignKey("MaterialId")
            ...
            modelBuilder.Entity("IMCore.Domain.ProgramBranchMapping", b =>
                {
                    b.HasOne("IMCore.Domain.Branch", "Branch")
                        .WithMany("ProgramBranchMappings")
                        .HasForeignKey("BranchId")
            ...
            modelBuilder.Entity("IMCore.Domain.UserBranchDivisionAssignment", b =>
                {
                    b.HasOne("IMCore.Domain.Branch", "Branch")
                        .WithMany("UserBranchDivisionAssignments")
                        .HasForeignKey("BranchId")
