...
namespace IMCore.Data
{
    public partial class IMCoreContext : DbContext
    {
        ...
        public virtual DbSet<ClientTypeReports> ClientTypeReports { get; set; }
        public virtual DbSet<CompanyInfo> CompanyInfo { get; set; }
        public virtual DbSet<ContactTitles> ContactTitles { get; set; }
        ...
        public virtual DbSet<EmailImages> EmailImages { get; set; }
        ...
        public virtual DbSet<MatSubCat> MatSubCat { get; set; }
        public virtual DbSet<MaterialCatagory> MaterialCatagory { get; set; }
        ...
        public virtual DbSet<MaterialTypesMarketMapping> MaterialTypesMarketMapping { get; set; }
        public virtual DbSet<MeasureCompCalcData> MeasureCompCalcData { get; set; }
        public virtual DbSet<MeasureCompCustData> MeasureCompCustData { get; set; }
        public virtual DbSet<MeasureCompLineItemData> MeasureCompLineItemData { get; set; }
        public virtual DbSet<MeasureCompOrderData> MeasureCompOrderData { get; set; }
        ...
        public virtual DbSet<OrderBasicLaborDetails> OrderBasicLaborDetails { get; set; }
        public virtual DbSet<OrderCustomDetails> OrderCustomDetails { get; set; }
        public virtual DbSet<OrderDiagrams> OrderDiagrams { get; set; }
        public virtual DbSet<OrderDocument> OrderDocument { get; set; }
        public virtual DbSet<OrderOptionsDetails> OrderOptionsDetails { get; set; }
        public virtual DbSet<OrderRegMerchandiseDetails> OrderRegMerchandiseDetails { get; set; }
        public virtual DbSet<OrderSomerchandiseDetails> OrderSomerchandiseDetails { get; set; }
        ...
        public virtual DbSet<Ponotes> Ponotes { get; set; }
        public virtual DbSet<Pophotos> Pophotos { get; set; }
        ...
        public virtual DbSet<UserTaskTypes> UserTaskTypes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Admins>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    .WithOne(p => p.Admins)
                    .HasForeignKey<Admins>(d => d.EmployeeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<BillDetails>(entity =>
            {
                ...
                entity.HasOne(d => d.WorkOrder)
                    ...
                    .HasForeignKey<BillDetails>(d => d.WorkOrderId)
            ...
            modelBuilder.Entity<ChargeBacks>(entity =>
            {
                entity.HasIndex(e => e.OrderId);
            ...
            modelBuilder.Entity<ClientTypeReports>(entity =>
            {
            ...
            modelBuilder.Entity<MatSubCat>(entity =>
            {
                entity.Property(e => e.Description).IsUnicode(false);
            });

            modelBuilder.Entity<MaterialCatagory>(entity =>
            {
                entity.Property(e => e.Active).HasDefaultValueSql("((1))");
            ...
            modelBuilder.Entity<MaterialTypesMarketMapping>(entity =>
            {
            ...
            modelBuilder.Entity<MeasureCompCalcData>(entity =>
            {
                entity.HasOne(d => d.Order)
            ...
            modelBuilder.Entity<MeasureCompCustData>(entity =>
            {
            ...
            modelBuilder.Entity<MeasureCompLineItemData>(entity =>
            {
            ...
            modelBuilder.Entity<OrderBasicLaborDetails>(entity =>
            {
                entity.HasIndex(e => e.OrderId);
            ...
            modelBuilder.Entity<OrderCustomDetails>(entity =>
            {
            ...
            modelBuilder.Entity<OrderDiagrams>(entity =>
            {
            ...
            modelBuilder.Entity<OrderOptionsDetails>(entity =>
            {
            ...
            modelBuilder.Entity<OrderRegMerchandiseDetails>(entity =>
            {
                entity.HasIndex(e => e.OrderId);
            ...
            modelBuilder.Entity<OrderSomerchandiseDetails>(entity =>
            {
                entity.HasIndex(e => e.OrderId);
            ...
            modelBuilder.Entity<Orders>(entity =>
            {
                ...
                entity.HasOne(d => d.PrimaryOrder)
                    .WithMany(p => p.InversePrimaryOrder)
                    .HasForeignKey(d => d.PrimaryOrderId)
            ...
            modelBuilder.Entity<Ponotes>(entity =>
            {
            ...
            modelBuilder.Entity<Pophotos>(entity =>
            {
                entity.HasOne(d => d.Order)
            ...
            modelBuilder.Entity<Spnactions>(entity =>
            {
                entity.Property(e => e.Id).ValueGeneratedNever();
            });
            ...
            {
                entity.Property(e => e.SpokeWith1).ValueGeneratedNever();
            ...
            modelBuilder.Entity<StoreContacts>(entity =>
            {
                entity.HasOne(d => d.Department)
