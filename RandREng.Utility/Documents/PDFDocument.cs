...
namespace RandREng.Utility.Documents
{
	...
	//		Gnostice.Documents.Image.Image i = new Gnostice.Documents.Image.Image();
	//		i.FormatType = FormatType.WYSIWYGSinglePage;
	//		i		}
	...
	//							bm = (System.Drawing.Bitmap)pdfImage.Get.GetDrawingImage();
	//						}
	...
	//			this.pdfDocument = new PdfDocument(PageSize.LETTER, PAGE_LEFT_MARGIN, PAGE_RIGHT_MARGIN, PAGE_TOP_MARGIN, PAGE_BOTTOM_MARGIN);
	//			this.writer = PdfWriter.GetInstance(pdfDocument, stream);
	...
	//		else
	//		{
	//			return iTextSharp.text.Image.GetInstance(image);
	//		}
	//	}
	//	public void Close()
	//	{
